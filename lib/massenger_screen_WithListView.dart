            ...
            children: [
              ...
              Container(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context , index) =>bulidStoryItem(), itemCount: 10),
              ),
              SizedBox(height: 20,),
              ListView.separated(
                physics: NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              scrollDirection:Axis.vertical ,itemBuilder: (index , context)=> bulidChatItem(),
              separatorBuilder :(context,index)=> SizedBox(height : 15.0) , itemCount: 10) ,
